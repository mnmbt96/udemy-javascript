...
class App {
  ...
  _loadMap(position) {
    ...
    this.#map = L.map('map').setView(coors, this.#mapZoomLevel);
  ...
  _newWorkout(e) {
    ...
    //Add the new object to workout activity
